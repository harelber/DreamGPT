...
ATT='location'
POINT_OF_VIEW='Model'
DESIRED_VALUES=["garden","Garden","sea","ocean","forest","Forest",\
                "meadow","lake","waterfall","river","Waterfall",\
                    "mountain","field","Field","Oasis","oasis",\
                    "island","lagoon","sky","Sky","hills","pond"]
